...
"}")
        ...
        self.gridLayout_7.addWidget(self.tabWidget, 3, 0, 1, 1)
        ...
        self.pushButton_7.clicked.connect(self.generate_clicked) # type: ignore
        self.radioButton.toggled['bool'].connect(lambda checked: self.month_clicked(self.radioButton)) # type: ignore
        self.radioButton_2.toggled['bool'].connect(lambda checked: self.month_clicked(self.radioButton_2)) # type: ignore
        self.radioButton_3.toggled['bool'].connect(lambda checked: self.month_clicked(self.radioButton_3)) # type: ignore
        self.radioButton_4.toggled['bool'].connect(lambda checked: self.month_clicked(self.radioButton_4)) # type: ignore
        self.radioButton_5.toggled['bool'].connect(lambda checked: self.month_clicked(self.radioButton_5)) # type: ignore
        self.radioButton_6.toggled['bool'].connect(lambda checked: self.month_clicked(self.radioButton_6)) # type: ignore
        self.radioButton_7.toggled['bool'].connect(lambda checked: self.month_clicked(self.radioButton_7)) # type: ignore
        self.radioButton_8.toggled['bool'].connect(lambda checked: self.month_clicked(self.radioButton_8)) # type: ignore
        self.radioButton_9.toggled['bool'].connect(lambda checked: self.month_clicked(self.radioButton_9)) # type: ignore
        self.radioButton_10.toggled['bool'].connect(lambda checked: self.month_clicked(self.radioButton_10)) # type: ignore
        self.radioButton_12.toggled['bool'].connect(lambda checked: self.month_clicked(self.radioButton_12)) # type: ignore
        self.radioButton_11.toggled['bool'].connect(lambda checked: self.month_clicked(self.radioButton_11)) # type: ignore
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.radioButton_12.setText(_translate("MainWindow", "11"))
        self.radioButton_11.setText(_translate("MainWindow", "12"))
        ...
        self.label.setText(_translate("MainWindow", "Time Attandance Management Tool"))
        self.tableWidget.horizontalHeader().setSectionResizeMode(QHeaderView.Stretch)
        self.tableWidget.horizontalHeader().setSectionResizeMode(0, QHeaderView.ResizeToContents)
        self.tableWidget.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)

    def month_clicked(self, btn):
        self.month = int(btn.text())
        self.statusbar.showMessage("Month is: " + str(int(btn.text())), 5000)
    ...
    def enter_clicked(self):
        ...
        if not search_class.feedback:
            for i in range(31):
                ...
                self.tableWidget.setItem(i, 7, QtWidgets.QTableWidgetItem(''))
            self.statusbar.showMessage("no staff id: " + staff_id + " in this file", 5000)
        else:
            search_class.df = search_class.df.fillna('')
            for i in range(31):
                ...
                self.tableWidget.setItem(i, 6, QtWidgets.QTableWidgetItem(f'{search_class.df.iloc[i, 6]}'))
                self.tableWidget.setItem(i, 7, QtWidgets.QTableWidgetItem(f'{search_class.df.iloc[i, 7]}'))
                if str(search_class.df.iloc[i, 6]) == "on leave" or \
                    str(search_class.df.iloc[i, 6]) == "no log record" or \
                    str(search_class.df.iloc[i, 6]) == "on business trip" or \
                    str(search_class.df.iloc[i, 6]) == "out of office" or \
                    str(search_class.df.iloc[i, 6]) == "card problem" or \
                    str(search_class.df.iloc[i, 6]) == "clock out missing" or \
                    str(search_class.df.iloc[i, 6]) == "clock in missing" or \
                    str(search_class.df.iloc[i, 6]) == "come late" or \
                    str(search_class.df.iloc[i, 6]) == "leave early":
                    self.tableWidget.item(i, 6).setBackground(QBrush(QColor(255, 0, 0)))
    ...
    def gti_file_button_clicked(self):
        ...
        if file_name:
            ...
            self.statusbar.showMessage("out of office file path: " + file_name, 5000)
    ...
    def generate_clicked(self):
        if self.month == 0:
            self.statusbar.showMessage("Please choose a month", 5000)
        elif not self.lineEdit_3.text() or not self.lineEdit_5.text() or not self.lineEdit_6.text() or not self.lineEdit_7.text() or not self.lineEdit_8.text() or not self.lineEdit_4.text():
            self.statusbar.showMessage("Please select all files", 5000)
        else:
            log_df = ReadExcelClass(self.lineEdit_3.text().replace('/', '\\'))
            leave_df = ReadExcelClass(self.lineEdit_5.text().replace('/', '\\'))
            business_trip_df = ReadExcelClass(self.lineEdit_6.text().replace('/', '\\'))
            ooo_df = ReadExcelClass(self.lineEdit_7.text().replace('/', '\\'))
            card_problem_df = ReadExcelClass(self.lineEdit_8.text().replace('/', '\\'))
            employee_df = ReadExcelClass(self.lineEdit_4.text().replace('/', '\\'))
            log_df.read__file()
            leave_df.read__file()
            ...
            bindClass = BindClass(self.month, log_df, employee_df, leave_df, business_trip_df, ooo_df, card_problem_df)
            bindClass.convert_excel()
            self.statusbar.showMessage("Access logbook create successfully! file path: " + os.path.dirname(bindClass.log_record.path) + '\\Access_logbook.xlsx', 5000)
